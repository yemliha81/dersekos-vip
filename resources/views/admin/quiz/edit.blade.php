...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Quiz Güncelleme</h3></div>
              <div class="col-sm-6">
                                    ...
                                    <div class="card-body">
                                       <div class="">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ $quiz->subtitle }}" required>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="json_data" class="form-label">Json Data </label>
                                            <textarea class="form-control " id="json_data" rows="20" name="json_data" rows="3"  required>{{ $quiz->json_data }}</textarea>
                                        </div>
