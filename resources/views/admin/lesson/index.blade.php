                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.lesson.create', $grade->grade_id) }}" class="btn btn-primary">
                            ...
                            <tbody class="connectedSortable">
                                @foreach($lessons as $item)
                                    <tr>
                                            <td>{{ $item->name }}</td>
                                        <td>
                                            <a href="{{ route('admin.lesson.edit', $item->lesson_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <a href="{{ route('admin.content_category', ['lesson_id' => $item->lesson_id]) }}" class="btn btn-info btn-sm">Kategoriler</a>
                                            <form action="{{ route('admin.lesson.destroy', $item->lesson_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
