                ...
                <div class="card">
                    ...
                    <?php
                        foreach($grades as $grade){
                            $grade_id[$grade->lang] = $grade->page_id;
                            $title[$grade->lang] = $grade->name;
                            $description[$grade->lang] = $grade->description;
                            $seo_url[$grade->lang] = $grade->seo_url;
                            $seo_title[$grade->lang] = $grade->seo_title;
                            $seo_description[$grade->lang] = $grade->seo_description;
                            $seo_keywords[$grade->lang] = $grade->seo_keywords;
                        }
                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.grade.store', $grade_id[$language->lang_code]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            
                            <div class="tab-content" id="myTabContent">
                                @foreach($languages as $language)
                                <input type="hidden" name="grade_id" value="{{ $grade_id[$language->lang_code] }}">
