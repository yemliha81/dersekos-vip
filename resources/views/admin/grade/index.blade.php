...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Sınıf Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Sınıf Listesi</h5>
                            ...
                            <tbody class="connectedSortable">
                                @foreach($grades as $item)
                                    <tr>
                                            <td>{{ $item->name }}</td>
                                        <td>
                                            <a href="{{ route('admin.grade.edit', $item->grade_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <a href="{{ route('admin.grade.lessons', $item->grade_id) }}" class="btn btn-info btn-sm">Dersler</a>
                                            <form action="{{ route('admin.grade.destroy', $item->grade_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
